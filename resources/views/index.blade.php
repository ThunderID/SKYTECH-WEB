...
<div class="global-overlay shadow-9">
    ...
    <div class="frame">
        <div class="frame-inner frame-inner-a bg-white"></div>
        <div class="frame-inner frame-inner-b bg-white"></div>
    </div>
</div>
        ...
        <div class="home-block-inner">
            ...
            <section id="home" class="d-flex min-vh--100">
                <div class="container align-self-center text-white">
                    ...
                    <p class="lead mb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio quia assumenda quae aspernatur recusandae vel </p>
                    <div class="row">
                                ...
                                <form class="mb-0" id="sf" name="sf" action="include/subscribe.php" method="post" autocomplete="off" novalidate="novalidate">
                                    <div class="row mx-0">
                                        ...
                                        <div class="col-12 col-sm-4 px-0">
                                            <button class="btn btn-primary rounded-0 btn-block shadow-3" type="submit" id="sf-submit" name="sf-submit">Notify Me</button>
                                        </div>
